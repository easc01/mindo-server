...
ALTER TABLE "watched_video" ADD FOREIGN KEY ("youtube_video_id") REFERENCES "youtube_video" ("id");
ALTER TABLE "watched_playlist" ADD FOREIGN KEY ("user_id") REFERENCES "user" ("id");
ALTER TABLE "watched_playlist" ADD FOREIGN KEY ("playlist_id") REFERENCES "playlist" ("id");
...
ALTER TABLE "quiz_result_question" ADD FOREIGN KEY ("quiz_result_id") REFERENCES "quiz_result" ("id");
ALTER TABLE "quiz_result_question" ADD FOREIGN KEY ("quiz_question_id") REFERENCES "quiz_question" ("id");
